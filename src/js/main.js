...
let startBtn = document.getElementById("start"),
    ...
    dayBudjetValue = document.getElementsByClassName("daybudget-value")[0],
    ...
    exprensesItem = document.getElementsByClassName("expenses-item"),
...
expensesBtn.addEventListener('click', function() {
    ...
    countBtn.addEventListener('click', function() {
        ...
        if (appData.budget != undefined) {
            ...
            dayBudjetValue.textContent = "Произошла ошибка!";
        }
    });
